...
Split modules (re-exported here for backward-compat):
  ...
  juggle_watchdog_orphans.py  — check_orphaned_threads (Loop 2 orphan scan)
  juggle_watchdog_recovery.py — execute_recovery (stalled/crashed reap + re-dispatch)
"""
...
from juggle_watchdog_orphans import check_orphaned_threads  # noqa: E402, F401
...
# ---------------------------------------------------------------------------
# Recovery (extracted; re-exported for existing imports)
# ---------------------------------------------------------------------------

from juggle_watchdog_recovery import execute_recovery  # noqa: E402, F401
