...
MISC_COMMANDS: tuple[Cmd, ...] = (
    ...
    Cmd("context", "show", cmd_get_context, help="Print context string"),
    Cmd("db", "init", cmd_init_db, help="Initialize DB schema"),
    ...
    Cmd("action", "next", cmd_next_action, help="Switch to highest-priority action item"),
    Cmd("research", "run", cmd_research,
        args=(
