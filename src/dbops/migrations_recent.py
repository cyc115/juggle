...
def _migrate_45_drop_status_check(conn: sqlite3.Connection) -> None:
    """Migration 45 (selfheal-triage-v2 P1, 2026-06-21): drop the status CHECK on
    error_events so new statuses (non_issue, non_issue_proposed) are legal.
