...
from juggle_cockpit_helpers import (
    ...
    _resolve_actions_by_thread_label,  # noqa: F401 — re-exported; tests import from juggle_cockpit
    _resolve_agent_by_index,  # noqa: F401 — re-exported; tests import from juggle_cockpit
    _resolve_thread_by_label,  # noqa: F401 — re-exported; tests import from juggle_cockpit
    _send_desktop_notification,
    _tmux_capture_pane,  # noqa: F401 — re-exported; tests import from juggle_cockpit
    _tmux_focus_pane,  # noqa: F401 — re-exported; tests import from juggle_cockpit
)
from juggle_cockpit_modals import (
    _ConfirmModal,  # noqa: F401 — re-exported; tests import from juggle_cockpit
    _HelpModal,
)
...
class CockpitApp(GraphModeMixin, CockpitActionsMixin, App):
    """Juggle Cockpit v2."""
