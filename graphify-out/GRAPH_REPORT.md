# Graph Report - juggle-juggle-BC  (2026-06-17)

## Corpus Check
- 430 files · ~447,923 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10570 nodes · 17553 edges · 1565 communities (423 shown, 1142 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 4844 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8fd71df6`
...
## Communities (1565 total, 1142 thin omitted)
...
Cohesion: 0.12
Nodes (24): Read DB state into a frozen CockpitState. Only function that touches DB.      Op, Read DB state into a frozen CockpitState. Only function that touches DB.      Op, Read DB state into a frozen CockpitState. Only function that touches DB.      Op, Read DB state into a frozen CockpitState. Only function that touches DB.      Op, Read DB state into a frozen CockpitState. Only function that touches DB.      Op, snapshot(), _make_project_graph(), TDD tests for lazy DAG loading in the cockpit snapshot.  snapshot(db, load_graph (+16 more)
...
Cohesion: 0.20
Nodes (27): _generate_title_for_thread(), Generate a 5-10 word title. Fallback chain: OpenRouter → Haiku → first 5 words., Generate a 5-10 word title. Fallback chain: OpenRouter → Haiku → first 5 words., Generate a specific, non-duplicate title. OpenRouter → Haiku → first 5 words., _cfg(), _db(), Tests for title generation fallback chain and settings defaults., OpenRouter is skipped when OPENROUTER_KEY env var is absent (new gating mechanis (+19 more)
...
Cohesion: 0.08
Nodes (33): _make_topic(), TDD tests for the T hotkey task-detail modal feature.  Covers:   1. resolve_task, Returns None for empty task list., CockpitApp.BINDINGS must have a binding for action 'task_detail'., The task_detail binding uses key 'T' or 'shift+t'., task_detail binding appears after the 't' (tail_toggle) binding., resolve_thread_detail matches case-insensitively., _TopicDetailModal class must be importable from juggle_cockpit_modals. (+25 more)
...
Cohesion: 0.09
Nodes (34): _get_hindsight_client(), Return HindsightClient or None if disabled/unconfigured., Return HindsightClient or None if disabled/unconfigured., cmd_digest(), cmd_get_context(), cmd_grep_vault(), cmd_init_db(), cmd_next_action() (+26 more)
...
Cohesion: 0.13
Nodes (33): _bind_running_thread(), _bind_running_topic(), _complete(), _merged_repo(), _mk_graph(), _mk_topic_task(), Tests for autopilot Phase 2 contracts: --handoff enforcement on complete-agent (, b has no dependents — the contract only binds tasks others consume. (+25 more)
...
Cohesion: 0.13
Nodes (16): ensure_watchdog(), PID recorded in this DB's watchdog lock file, or None., Lock-gated ensure-exists: start a detached watchdog only if none is live.      R, R hotkey: kill the existing watchdog and relaunch from the canonical main     pa, read_lock_pid(), restart_watchdog(), _kill(), TDD: cockpit owns a lock-gated, DETACHED watchdog + W/R hotkeys (T-cockpit-watch (+8 more)

### Community 876 - "Community 876"
Cohesion: 0.11
Nodes (24): _is_pid_alive(), Return seconds since last heartbeat, or None if the file is missing., Pure decision: True if the watchdog should be (re)started., Start the watchdog as a child process (same process group as caller).      Idemp, read_heartbeat_age(), start_watchdog_child(), watchdog_needs_start(), TDD — watchdog_needs_start, start_watchdog_child, should_exit_supervisor_gone, a (+16 more)
...
Cohesion: 0.06
Nodes (27): ComposeResult, ModalScreen, _ConfirmModal, _GraphNodeModal, _GraphTaskModal, _HelpModal, ComposeResult, Juggle Cockpit — Textual modal screens.  Extracted from juggle_cockpit.py for mo (+19 more)
...
Cohesion: 0.12
Nodes (22): get_db(), handle_pre_compact(), handle_session_start(), is_active(), juggle_hooks_checkpoint — PreCompact + SessionStart checkpoint handlers.  Owns:, Inject restoration context on resume or compact., Write checkpoint before compaction so SessionStart can restore state., Write checkpoint before compaction so SessionStart can restore state. (+14 more)
...
Cohesion: 0.12
Nodes (16): db(), _merged_repo(), JuggleDB, Path, REGRESSION PIN (2026-06-10): create_thread on db1 must be visible via     get_th, REGRESSION PIN (2026-06-10): create_thread on db1 must be visible via     get_th, REGRESSION PIN (2026-06-10): _dispatch_via_pool must pass db.db_path to     cmd_, REGRESSION PIN (2026-06-10): _dispatch_via_pool must pass db.db_path to     cmd_ (+8 more)
...
Cohesion: 0.08
Nodes (39): arm_project(), disarm_project(), get_armed_project(), get_armed_projects(), juggle_autopilot_state — armed-project SET accessors (multi-project autopilot)., Ordered, deduped armed project ids; [] when disarmed or pre-migration., Persist the set; empty list clears the key (disarmed)., Append ``pid`` to the armed set (idempotent). Returns the new set. (+31 more)
...
Cohesion: 0.07
Nodes (50): get_repo_config(), Return integration config for repo_path with safe defaults.      Unknown repos g, Return integration config for repo_path with safe defaults.      Unknown repos g, Return integration config for repo_path with safe defaults.      Unknown repos g, _add_commit(), git_repo(), git_repo_with_remote(), _make_db() (+42 more)
...
Cohesion: 0.02
Nodes (113): App, CockpitApp, Generic one-line input modal. Dismisses with the stripped value or None.      di, Single-keypress y/N confirm gate.      Dismisses True on 'y', False on 'n' or Es, Help overlay listing all bindings, generated from CockpitApp.BINDINGS., Intercept Tab/Shift+Tab before Textual focus traversal; clear filter on Escape., Intercept Tab/Shift+Tab before Textual focus traversal; clear filter on Escape., Intercept Tab/Shift+Tab before Textual focus traversal; clear filter on Escape. (+105 more)
...
Cohesion: 0.06
Nodes (27): _PromptModal, Generic one-line input modal. Dismisses with the stripped value or None.      di, Generic one-line input modal. Dismisses with the stripped value or None.      di, s — switch active thread by label., s — switch active thread by label., a — ack all open action items on a thread by label., a — ack all open action items on a thread by label (Z = orphaned/null-thread)., C — close thread by label (y/N confirm). (+19 more)
...
Cohesion: 0.08
Nodes (34): _deep_merge(), get(), get_nested(), get_settings(), # NOTE: the claude.ai Google Workspace connectors (Drive,, # NOTE: the claude.ai Google Workspace connectors (Drive,, # NOTE: the claude.ai Google Workspace connectors (Drive,, Recursively merge override into base. Returns a new dict. (+26 more)
...
Cohesion: 0.11
Nodes (25): acquire_singleton_lock(), _any_alive(), assert_launch_allowed(), find_watchdog_pids(), is_prod_db(), is_sanctioned(), is_watchdog_alive(), lock_path_for() (+17 more)
...
Cohesion: 0.18
Nodes (11): Match query against topic.label (case-insensitive). Returns Topic or None., Match query against topic.label (case-insensitive). Returns Topic or None., resolve_thread_detail(), resolve_thread_detail returns the Topic whose label matches the query., resolve_thread_detail returns None when no topic matches., resolve_thread_detail returns None for empty list., resolve_thread_detail returns None for empty query., test_resolve_thread_detail_by_label() (+3 more)
...
Cohesion: 0.25
Nodes (7): ? — show help overlay., ? — show help overlay., ? — show help overlay., ? — show help overlay., ? — show help overlay., ? — show help overlay., ? — show help overlay.
...
Cohesion: 0.21
Nodes (19): test_graphify_hooks.sh script, test_graphify_hooks.sh script, test_graphify_hooks.sh script, test_graphify_hooks.sh script, test_graphify_hooks.sh script, test_graphify_hooks.sh script, test_graphify_hooks.sh script, fail() (+11 more)
...
Cohesion: 0.09
Nodes (22): _existing_thread_titles(), _humanize_dt(), _last_sentences(), Return a human-friendly relative time string for an ISO-8601 UTC timestamp., Return the tail of text, capped at max_chars., Return the tail of text, capped at max_chars., Return the tail of text, capped at max_chars., Non-empty titles of all OTHER threads, for dedup-awareness. Fail-soft. (+14 more)
...
Cohesion: 0.26
Nodes (16): _action_items(), _agent_row(), _capture(), _notifications(), Active suite: watchdog detects + handles all 5 states. Skipped automatically whe, Crashed: thread marked failed, action item filed, agent record cleaned up., Stuck-at-prompt: watchdog sends Enter, pane advances, notification logged, no ac, Working agent: inspect returns 'working', no spurious action items. (+8 more)
...
Cohesion: 0.19
Nodes (17): smoke_test_agent_compliance.sh script, smoke_test_agent_compliance.sh script, smoke_test_agent_compliance.sh script, smoke_test_agent_compliance.sh script, smoke_test_agent_compliance.sh script, smoke_test_agent_compliance.sh script, smoke_test_agent_compliance.sh script, smoke_test_agent_compliance.sh script (+9 more)
...
Cohesion: 0.15
Nodes (20): _cheap_llm_call(), llm_call(), Profile-based LLM dispatcher.      Profiles defined in settings.llm_profiles (ch, Shim: delegates to llm_call(profile='cheap'). Kept for call-site compat., Shim: delegates to llm_call(profile='cheap'). Kept for call-site compat., Shim: delegates to llm_call(profile='cheap'). Kept for call-site compat., llm_call(), Logger (+12 more)
...
Cohesion: 0.06
Nodes (71): _age_claim(), _age_topic_claim(), _arm(), _arm_many(), _bind_merged_topic(), _dep_topic(), FakeDispatch, _mk() (+63 more)
...
Cohesion: 0.18
Nodes (10): LANG, stuck-at-prompt.sh script, stuck-at-prompt.sh script, stuck-at-prompt.sh script, stuck-at-prompt.sh script, stuck-at-prompt.sh script, stuck-at-prompt.sh script, stuck-at-prompt.sh script (+2 more)
...
Cohesion: 0.09
Nodes (18): Cockpit bell-on-new-blocker tests: bell state attrs + _refresh diff firing rules, First _refresh (prev state empty) does NOT call self.bell()., CockpitApp.__init__ initialises _prev_action_ids and _prev_agent_statuses., CockpitApp.__init__ initialises _bell_enabled., New tier-0 action on 2nd _refresh fires self.bell(); 1st tick does not., Agent transitioning busy→stale on 2nd _refresh fires self.bell()., test_bell_enabled_attr_exists(), test_bell_fires_on_agent_failure() (+10 more)
...
Cohesion: 0.20
Nodes (9): crashed.sh script, crashed.sh script, crashed.sh script, crashed.sh script, crashed.sh script, crashed.sh script, crashed.sh script, crashed.sh script (+1 more)

### Community 1548 - "Community 1548"
Cohesion: 0.20
Nodes (9): recoverable-prompt.sh script, recoverable-prompt.sh script, recoverable-prompt.sh script, recoverable-prompt.sh script, recoverable-prompt.sh script, recoverable-prompt.sh script, recoverable-prompt.sh script, recoverable-prompt.sh script (+1 more)

### Community 1549 - "Community 1549"
Cohesion: 0.20
Nodes (9): stalled-silent.sh script, stalled-silent.sh script, stalled-silent.sh script, stalled-silent.sh script, stalled-silent.sh script, stalled-silent.sh script, stalled-silent.sh script, stalled-silent.sh script (+1 more)

### Community 1550 - "Community 1550"
Cohesion: 0.20
Nodes (9): working.sh script, working.sh script, working.sh script, working.sh script, working.sh script, working.sh script, working.sh script, working.sh script (+1 more)
...
Cohesion: 0.22
Nodes (8): install-graphify-hooks.sh script, install-graphify-hooks.sh script, install-graphify-hooks.sh script, install-graphify-hooks.sh script, install-graphify-hooks.sh script, install-graphify-hooks.sh script, install-graphify-hooks.sh script, install-graphify-hooks.sh script

## Knowledge Gaps
- **970 isolated node(s):** `name`, `name`, `plugins`, `name`, `description` (+965 more)
...
- **Why does `JuggleDB` connect `Community 0` to `Community 1`, `Community 4`, `Community 8`, `Community 11`, `Community 12`, `Community 13`, `Community 1551`, `Community 1554`, `Community 1043`, `Community 19`, `Community 21`, `Community 1555`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 29`, `Community 30`, `Community 543`, `Community 32`, `Community 39`, `Community 40`, `Community 41`, `Community 46`, `Community 48`, `Community 566`, `Community 60`, `Community 61`, `Community 62`, `Community 1122`, `Community 1130`, `Community 1137`, `Community 1138`, `Community 1143`, `Community 1144`, `Community 1169`, `Community 1172`, `Community 1195`, `Community 707`, `Community 201`, `Community 1243`, `Community 227`, `Community 795`, `Community 798`, `Community 800`, `Community 803`, `Community 805`, `Community 296`, `Community 820`, `Community 821`, `Community 822`, `Community 828`, `Community 835`, `Community 839`, `Community 841`, `Community 844`, `Community 853`, `Community 854`, `Community 865`, `Community 871`, `Community 877`, `Community 879`, `Community 1394`, `Community 883`, `Community 1398`, `Community 888`, `Community 1404`, `Community 1405`, `Community 893`, `Community 895`, `Community 896`, `Community 897`, `Community 898`, `Community 900`, `Community 389`, `Community 902`, `Community 1416`, `Community 1417`, `Community 1418`, `Community 1419`, `Community 1420`, `Community 1421`, `Community 909`, `Community 911`, `Community 1427`, `Community 916`, `Community 917`, `Community 1433`, `Community 921`, `Community 925`, `Community 932`, `Community 934`, `Community 1450`, `Community 939`, `Community 941`, `Community 1455`, `Community 1475`, `Community 1493`, `Community 1501`, `Community 1508`, `Community 1513`, `Community 1519`, `Community 1520`, `Community 1524`, `Community 1528`, `Community 1530`, `Community 1531`, `Community 1534`?**
  _High betweenness centrality (0.324) - this node is a cross-community bridge._
- **Why does `Path` connect `Community 822` to `Community 896`, `Community 0`, `Community 1282`, `Community 4`, `Community 6`, `Community 11`, `Community 1420`, `Community 12`, `Community 1419`, `Community 1424`, `Community 1169`, `Community 1554`, `Community 17`, `Community 1428`, `Community 1043`, `Community 1553`, `Community 1431`, `Community 1434`, `Community 1439`, `Community 31`, `Community 801`, `Community 38`, `Community 42`, `Community 43`, `Community 47`, `Community 1073`, `Community 693`, `Community 832`, `Community 839`, `Community 841`, `Community 844`, `Community 855`, `Community 1392`, `Community 880`, `Community 1136`, `Community 1396`, `Community 890`, `Community 1403`, `Community 1404`, `Community 1405`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `datetime` connect `Community 888` to `Community 0`, `Community 1`, `Community 1282`, `Community 900`, `Community 778`, `Community 1420`, `Community 1421`, `Community 14`, `Community 12`, `Community 15`, `Community 1043`, `Community 916`, `Community 1172`, `Community 1429`, `Community 1434`, `Community 32`, `Community 932`, `Community 805`, `Community 938`, `Community 171`, `Community 1455`, `Community 50`, `Community 822`, `Community 828`, `Community 707`, `Community 844`, `Community 1493`, `Community 856`, `Community 1242`, `Community 1501`, `Community 1122`, `Community 1134`, `Community 1394`, `Community 243`, `Community 1527`, `Community 1020`, `Community 893`?**
